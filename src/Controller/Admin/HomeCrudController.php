...
class HomeCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield TextField::new('block1TitleSeo')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block1Title')->setColumns('col-sm-6');
        yield TextEditorField::new('block1Text')->hideOnIndex()->setColumns('col-sm-6');
        yield TextField::new('block1Btn')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block1BtnLink')->setColumns('col-sm-6')->hideOnIndex();
        ...
        yield TextField::new('block2TitleSeo')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block2Title')->setColumns('col-sm-6');
        yield TextEditorField::new('block2Text')->setColumns('col-sm-6')->hideOnIndex();
        ...
        yield TextField::new('block3TitleSeo')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block3Title')->setColumns('col-sm-6');
        yield TextEditorField::new('block3Text')->setColumns('col-sm-6')->hideOnIndex();
        ...
        yield TextField::new('block5TitleSeo')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block5Title')->setColumns('col-sm-6');
        yield TextEditorField::new('block5Text')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block5Btn')->setColumns('col-sm-6')->hideOnIndex();
        yield TextField::new('block5BtnLink')->setColumns('col-sm-6')->hideOnIndex();
